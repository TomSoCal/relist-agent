# Relist Agent v2.1.0 Development Instructions

## Important: This is a v2.1.0 Copy

Files were copied from v2.0.0 to v2.1.0 on 2026-07-21. Same APP_ID and licensing rules apply.

---

## Critical Constraints

🛑 **Read CRITICAL_RULES.md first** (if it exists in source v2.0.0) — These are non-negotiable.
...
## App-Specific Licensing Rules (v2.1.0 = v2.0.0)

Relist Agent uses app-specific licensing to prevent key sharing with other apps.

**Key Facts:**
- APP_ID = "relist-agent" (same as v2.0.0 — DO NOT CHANGE)
- v2.1.0 and v2.0.0 share licenses on same computer (same APP_ID)
...
- ✅ v2.0.0 and v2.1.0 MUST share licenses on same PC (same APP_ID)
...
See parent directory v2.0.0 for LICENSING_GUIDE.md.
...
**v2.1.0 vs v2.0.0:**
- Same APP_ID ("relist-agent") → licenses are shared
- Same licensing rules apply
- All licensing code is identical
- No version-specific licensing changes

If making licensing changes, update BOTH v2.0.0 and v2.1.0 identically.
...
| `LICENSING_GUIDE.md` | Licensing system documentation (see v2.0.0) |
...
- [ ] ✅ v2.0.0 key works in v2.1.0: Same APP_ID means license sharing
